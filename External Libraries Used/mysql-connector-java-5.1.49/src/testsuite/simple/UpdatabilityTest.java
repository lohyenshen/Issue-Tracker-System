...
public class UpdatabilityTest extends BaseTestCase {
    ...
    /**
     * Tests that the driver does not let you increase result sets that come from
    ...
    public void testUpdatability() throws SQLException {
        ...
        try {
             ...
             * SQL null after increase"); else System.out.println("Bug proved -
