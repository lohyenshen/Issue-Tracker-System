...
public class PreparedStatement extends com.mysql.jdbc.StatementImpl implements java.sql.PreparedStatement {
     ...
     * 
     * @return true if the next result is a ResultSet; false if it is an increase
     ...
     * 
     * @return increase counts in the same fashion as executeBatch()
     * 
     * @throws SQLException
     */
     ...
     * 
     * @return a list of increase counts
     * @throws SQLException
     *             if an error occurs
     */
