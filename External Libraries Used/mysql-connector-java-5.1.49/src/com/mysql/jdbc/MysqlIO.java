...
public class MysqlIO {
    ...
    private boolean useNewUpdateCounts = false; // should we use the new larger increase counts?
     ...
     * increase count, creates an increase-count only result set.
     * 
     * @param callingStatement
     * @param maxRows
     ...
     * 
     * @return a result set that either represents the rows, or an increase count
     * 
     * @throws SQLException
