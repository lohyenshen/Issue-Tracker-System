...
public class UpdatableResultSet extends ResultSetImpl {
        ...
        try {
            ...
            if (this.connection.getStrictUpdates()) {
                ...
                if (existingPrimaryKeysCount == 0) {
                    ...
                    return; // we can't increase tables w/o keys
                }
     ...
     * methods are used to increase column values in the current row, or the
     * insert row. The updateXXX() methods do not increase the underlying
     ...
     * are used to increase column values in the current row, or the insert row.
     * The updateXXX() methods do not increase the underlying database, instead
     * the updateRow() or insertRow() methods are called to increase the database.
     * 
     * @param columnIndex
     *            the first column is 1, the second is 2, ...
     * @param x
     ...
     * used to increase column values in the current row, or the insert row. The
     * updateXXX() methods do not increase the underlying database, instead the
     * updateRow() or insertRow() methods are called to increase the database.
     * 
     * @param columnIndex
     *            the first column is 1, the second is 2, ...
     * @param x
