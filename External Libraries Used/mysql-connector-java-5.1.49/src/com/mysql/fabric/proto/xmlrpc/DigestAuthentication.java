/*
  Copyright (c) 2014, 2016, Oracle and/or its affiliates. Projects_And_Users rights reserved.
...
public class DigestAuthentication {
     ...
     * as the "Authorization" header in the request. Projects_And_Users parameters in
