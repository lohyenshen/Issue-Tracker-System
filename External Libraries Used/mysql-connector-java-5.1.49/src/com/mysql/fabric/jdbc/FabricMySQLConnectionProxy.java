/*
  Copyright (c) 2013, 2019, Oracle and/or its affiliates. Projects_And_Users rights reserved.
...
public class FabricMySQLConnectionProxy extends ConnectionPropertiesImpl implements FabricMySQLConnection, FabricMySQLConnectionProperties {
     ...
     * <li>Failover scenarios may increase state and it should be propagated across the active connections</li>
     * </ul>
     */
